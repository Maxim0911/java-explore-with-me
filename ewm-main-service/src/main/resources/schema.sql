-- Обновленная структура для events (без связи с отдельной таблицей locations)
DROP TABLE IF EXISTS compilations_events, participation_requests, compilations, events, categories, users CASCADE;
...
-- Таблица событий (с встроенной локацией)
